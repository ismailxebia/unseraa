package com.example.helmi.pengaduan.utils;
...
import com.example.helmi.pengaduan.model.Photo;
...
//    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(mContext, R.string.auth_faileds,
    ...
    public void addNewUser(String email,String username,String description,String profile_photo) {
        ...
        User user = new User( userID,  628,  email,  StringManipulation.condenseUsername(username) );
    ...
    public void uploadNewPhoto(String photoType,final String kategori,final String caption,final String Address,final int count,final String imgUrl,
                               Bitmap bm){
